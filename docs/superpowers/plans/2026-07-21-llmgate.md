...
- Single CLI entry: `llmgate`
- Distribution via `uv tool install`
- Config dir: `~/.config/llmgate/`
...
- Create: `src/llmgate/__init__.py`
...
packages = ["src/llmgate"]
```

- [ ] **Step 2: Write src/llmgate/__init__.py**
...
```bash
git add pyproject.toml src/llmgate/__init__.py uv.lock .gitignore
...
**Files:**
- Create: `src/llmgate/config/__init__.py`
- Create: `src/llmgate/config/crypto.py`
...
- [ ] **Step 1: Write src/llmgate/config/__init__.py**

```python
"""Config encryption and persistence."""
```

- [ ] **Step 2: Write src/llmgate/config/crypto.py**
...
```bash
git add src/llmgate/config/ tests/test_crypto.py
...
**Files:**
- Create: `src/llmgate/config/store.py`
...
- [ ] **Step 1: Write src/llmgate/config/store.py**
...
```bash
git add src/llmgate/config/store.py tests/test_store.py
...
**Files:**
- Create: `src/llmgate/models/__init__.py`
- Create: `src/llmgate/models/provider.py`
- Create: `src/llmgate/models/model.py`
...
- [ ] **Step 1: Write src/llmgate/models/__init__.py**

```python
"""Data models for llmgate."""
```

- [ ] **Step 2: Write src/llmgate/models/provider.py**
...
- [ ] **Step 3: Write src/llmgate/models/model.py**
...
```bash
git add src/llmgate/models/ tests/test_models.py
...
**Files:**
- Create: `src/llmgate/gateway/__init__.py`
- Create: `src/llmgate/gateway/router.py`
...
- [ ] **Step 1: Write src/llmgate/gateway/__init__.py**

```python
"""Gateway request routing and protocol handling."""
```

- [ ] **Step 2: Write src/llmgate/gateway/router.py**
...
```bash
git add src/llmgate/gateway/ tests/test_router.py
...
**Files:**
- Create: `src/llmgate/gateway/openai_handler.py`
- Create: `src/llmgate/gateway/anthropic_handler.py`
...
- [ ] **Step 1: Write src/llmgate/gateway/openai_handler.py**
...
- [ ] **Step 2: Write src/llmgate/gateway/anthropic_handler.py**
...
```bash
git add src/llmgate/gateway/openai_handler.py src/llmgate/gateway/anthropic_handler.py tests/test_handlers.py
...
**Files:**
- Create: `src/llmgate/gateway/server.py`
- Create: `src/llmgate/daemon.py`
...
- [ ] **Step 1: Write src/llmgate/gateway/server.py**
...
- [ ] **Step 2: Write src/llmgate/daemon.py**
...
```bash
git add src/llmgate/gateway/server.py src/llmgate/daemon.py tests/test_gateway.py
...
**Files:**
- Create: `src/llmgate/app.py`
- Create: `src/llmgate/ui/__init__.py`
- Create: `src/llmgate/ui/screens/__init__.py`
- Create: `src/llmgate/ui/widgets/__init__.py`

**Interfaces:**
- Produces: `app.LlmGateApp` — Textual `App` subclass with tab switching, daemon connection
...
```python
# src/llmgate/ui/__init__.py
"""TUI components for llmgate."""
```

```python
# src/llmgate/ui/screens/__init__.py
"""TUI screens."""
```

```python
# src/llmgate/ui/widgets/__init__.py
"""Reusable TUI widgets."""
```

- [ ] **Step 2: Write src/llmgate/app.py**
...
```bash
git add src/llmgate/app.py src/llmgate/ui/
...
**Files:**
- Create: `src/llmgate/ui/screens/models.py`
- Create: `src/llmgate/ui/screens/providers.py`
- Create: `src/llmgate/ui/screens/gateway.py`
- Create: `src/llmgate/ui/screens/stats.py`
- Create: `src/llmgate/ui/screens/settings.py`
- Create: `src/llmgate/ui/screens/onboarding.py`
...
- [ ] **Step 1: Write src/llmgate/ui/screens/models.py**
...
- [ ] **Step 2: Write src/llmgate/ui/screens/providers.py**
...
- [ ] **Step 3: Write src/llmgate/ui/screens/gateway.py**
...
- [ ] **Step 4: Write src/llmgate/ui/screens/stats.py**
...
- [ ] **Step 5: Write src/llmgate/ui/screens/settings.py**
...
- [ ] **Step 6: Write src/llmgate/ui/screens/onboarding.py**
...
```bash
git add src/llmgate/ui/screens/
...
**Files:**
- Create: `src/llmgate/cli.py`

**Interfaces:**
- Consumes: `LlmGateApp`, `DaemonManager`, `run_daemon`
- Produces: `cli.main()` — argument parsing, dispatches to daemon or TUI

**Dependencies:** Task 8, 9

- [ ] **Step 1: Write src/llmgate/cli.py**
...
- [ ] **Step 2: Verify CLI works in TUI mode** (manual: `uv run llmgate` — skip in CI)

- [ ] **Step 3: Commit**

```bash
git add src/llmgate/cli.py
...
```bash
cd /Users/aung/work/aung-i/llmhub && uv run llmgate --help
```
Expected: shows help text with `llmgate [stop|status]` options

- [ ] **Step 3: Verify daemon status when not running**

```bash
cd /Users/aung/work/aung-i/llmhub && uv run llmgate status
```
